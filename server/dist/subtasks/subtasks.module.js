...
exports.SubTasksModule = SubTasksModule = __decorate([
    (0, common_1.Module)({
        providers: [subtasks_service_1.SubTasksService, subtasks_repository_1.SubTasksRepository],
        controllers: [subtasks_controller_1.SubTasksController],
        exports: [subtasks_service_1.SubTasksService, subtasks_repository_1.SubTasksRepository],
    })
], SubTasksModule);
